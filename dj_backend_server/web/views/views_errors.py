...
from web.models.failed_jobs import FailedJob  # Assuming the model for the failed_jobs table is named FailedJob
...
def errors_check(request):
    ...
    return render(request, 'errors_check.html', {'errors': errors, 'paginator': paginator, 'page_obj': errors})
