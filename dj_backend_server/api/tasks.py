...
@shared_task
def pdf_handler_task(shared_folder, namespace,  metadata: Dict[str, Any]):
    return pdf_handler(shared_folder=shared_folder, namespace=namespace, metadata=metadata)

@shared_task 
def website_handler_task(shared_folder, namespace,  metadata: Dict[str, Any]):
    return website_handler(shared_folder=shared_folder, namespace=namespace, metadata=metadata)
