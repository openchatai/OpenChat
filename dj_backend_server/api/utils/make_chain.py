...
def get_initial_prompt_by_mode(mode, initial_prompt, chat_history=None, question=None, context=None) -> {'condense_prompt': PromptTemplate, 'qa_prompt': PromptTemplate}:
    default_condense_prompt = PromptTemplate(
