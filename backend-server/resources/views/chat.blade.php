                    ...
                    <div class="flex">
                        <div>
                            ...
                            <div x-data="{ modalOpen: false }">
                                <button class="btn bg-slate-100 hover:bg-slate-200  text-white" @click.prevent="modalOpen = true" aria-controls="announcement-modal">
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="mb-2 text-center">
                                                    ...
                                                    <div class="inline-flex mb-2">
                                                        <img src="/dashboard/images/announcement-icon.svg" width="80" height="80" alt="Announcement">
                                                    </div>
                                                    <div class="text-lg font-semibold text-slate-800">AI Powered Conversation</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-center">
                                                    <div class="text-sm mb-5">
                                                        This AI bot is programmed to exclusively respond to questions it has been trained on. It will refrain from providing answers to any inquiries outside its training data.                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            fetch("{{route('sendMessage', ['token' => $bot->getToken()])}}", {
                ...
                body: JSON.stringify({message: message, history: messageHistory}),
                timeout: 5000
            }).then(async response => {
                ...
                if (response.ok) {
                    ...
                    pushMessageFromBot(botMessage, chatPanel, messageInput);
                }
...
<!--                     alt="User 01"/>-->
        ...
        function pushMessageFromBot(message, chatPanel, messageInput) {
            let messageDiv = `<div class="flex items-start mb-4 last:mb-0" style="opacity: 0;">
        <div>
            <div
                class="text-sm bg-indigo-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent shadow-md mb-1">
            ...
            // Retrieve the last appended message
            let lastMessage = chatPanel.lastChild;

            // Update the opacity to trigger the transition
