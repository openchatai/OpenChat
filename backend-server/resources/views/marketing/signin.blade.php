            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div class="max-w-sm mx-auto">
                        ...
                        <form method="POST" action="{{route('marketing.login')}}">
                            @csrf
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                                    <label class="block text-gray-800 text-sm font-medium mb-1" for="email">Email</label>
                                    <input id="email" type="email" name="email" class="form-input w-full text-gray-800" placeholder="Enter your email address" required />
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full px-3">
                        ...
                        <div class="text-gray-600 text-center mt-6">
                            Don’t you have an account? <a class="text-blue-600 hover:underline transition duration-150 ease-in-out" href="{{route('marketing.register')}}">Sign up</a>
                        </div>
                    </div>
