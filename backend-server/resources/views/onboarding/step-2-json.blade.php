    ...
    <div class="min-h-screen h-full flex flex-col after:flex-1">
        ...
        <div class="px-4 py-8">
            <div class="max-w-md mx-auto">
                ...
                <h1 class="text-3xl text-slate-800 font-bold mb-6">Upload JSON files as sources ✨</h1>
                <!-- Form -->
                ...
                @endif
                <form action="{{route('onboarding.json.create')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-4 mb-8">
                        ...
                        <div>
                            <div class="image-uploader" id="imageUploader">
                                ...
                                <span
                                    style="color: #2563eb">
                                        you can upload up to 5 json files, and we will process the first ±100k words</span>
                            </div>
                            <input type="file" name="jsonfiles[]" id="fileInput" style="display: none" required
                        ...
                        <div class="flex items-center justify-between space-x-6 mb-8">
                            <div>
                                <div class="font-medium text-slate-800 text-sm mb-1">Make sure that your files are
                                    scannable (text not images) 🫶
                                </div>
                                <div class="text-xs">
        ...
        fileInput.addEventListener('change', (event) => {
            ...
            Array.from(files).forEach(file => {
                ...
                reader.onload = (e) => {
                    ...
                    imgElement.src = 'https://upload.wikimedia.org/wikipedia/commons/c/c9/JSON_vector_logo.svg';
