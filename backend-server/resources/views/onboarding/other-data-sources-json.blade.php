    ...
    <div class="min-h-screen h-full flex flex-col after:flex-1">
        ...
        <div class="px-4 py-8">
            <div class="max-w-md mx-auto">
                ...
                <h1 class="text-3xl text-slate-800 font-bold mb-6">Upload Json or Zip file as a source ✨</h1>
                <!-- Form -->
                ...
                @endif
                <form action="{{route('onboarding.other-data-sources-json.create', ['id' => request()->route('id')])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-4 mb-8">
                        ...
                        <div>
                            <div class="image-uploader" id="imageUploader">
                                ...
                                <span
                                    style="color: #2563eb">
                                        you can upload up to </span>
                            </div>
                            <input type="file" name="jsonfiles[]" id="fileInput" style="display: none" required accept="application/json, application/zip"
                                   multiple>
        ...
        fileInput.addEventListener('change', (event) => {
            ...
            Array.from(files).forEach(file => {
                ...
                reader.onload = (e) => {
                    ...
                    imgElement.src = 'https://www.json.org/img/json160.gif';
